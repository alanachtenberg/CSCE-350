...
.data
	prompt:						.asciiz "Please input the expression to evaluate in postfix form\n"
	stack_err_mesg: 			.asciiz "Error: item cannot be popped when the stack is empty\n"
	postfix_err_mesg: 			.asciiz "Error: Expression not formatted properly, make sure numbers are only one digit and no parentheses."
	postfix_expression_test: 	.asciiz "84-4/"
	postfix_expression_buff: 	.space  64
	NL:							.asciiz "\n"
	plus: 						.asciiz "+"
	minus: 						.asciiz "-"
	multiply: 					.asciiz "*"
